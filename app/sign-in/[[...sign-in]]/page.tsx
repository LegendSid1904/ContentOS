    ...
    <div className="min-h-screen bg-bg-void flex flex-col items-center justify-center p-6 relative overflow-hidden">
      ...
      <div className="crt-monitor crt-brackets w-full max-w-[420px] relative z-10">
        ...
        <div className="crt-monitor-header">
          ...
          <span className="font-mono text-[7px] tracking-[0.24em] uppercase text-te-400/70">AUTH</span>
          ...
          <SignIn
            ...
            appearance={{
              elements: {
                ...
                socialButtonsProviderText: "text-tx-2 font-mono text-[11px] tracking-wider",
                dividerRow: "my-6",
                ...
                formFieldError: "text-err text-[9px] font-mono mt-1",
