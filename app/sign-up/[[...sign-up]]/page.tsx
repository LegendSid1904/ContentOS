    ...
    <div className="min-h-screen bg-bg-void flex flex-col items-center justify-center p-6 relative overflow-hidden">
      ...
      <div className="crt-monitor crt-brackets w-full max-w-[420px] relative z-10">
        ...
        <div className="crt-monitor-header">
          ...
          <span className="font-mono text-[9px] tracking-[0.24em] uppercase text-te-400/70">REGISTER</span>
          ...
          <SignUp
            ...
            appearance={{
              elements: {
                ...
                identityPreviewText: "text-tx-2 font-mono text-[13px]",
                identityPreviewEditButton: "text-vi-400 hover:text-vi-300 font-mono text-[11px]",
                skipAction: "hidden",
